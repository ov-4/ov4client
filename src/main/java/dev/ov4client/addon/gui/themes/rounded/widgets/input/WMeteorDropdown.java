...
package dev.ov4client.addon.gui.themes.rounded.widgets.input;
...
public class WMeteorDropdown<T> extends WDropdown<T> implements ov4clientGuiWidget {
    ...
    private static class WRoot extends WDropdownRoot implements ov4clientGuiWidget {
        @Override
        protected void onRender(GuiRenderer renderer, double mouseX, double mouseY, double delta) {
            ov4clientGuiTheme theme = theme();
    ...
    private class WValue extends WDropdownValue implements ov4clientGuiWidget {
        @Override
