...
import dev.ov4client.addon.gui.themes.rounded.widgets.WMeteorLabel;
...
public class WMeteorTextBox extends WTextBox implements ov4clientGuiWidget {
    ...
    protected WContainer createCompletionsRootWidget() {
        return new WVerticalList() {
            ...
            protected void onRender(GuiRenderer renderer1, double mouseX, double mouseY, double delta) {
                ov4clientGuiTheme theme1 = theme();
