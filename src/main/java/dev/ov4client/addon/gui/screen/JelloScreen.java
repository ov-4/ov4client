...
import dev.ov4client.addon.utils.font.CFont;
import dev.ov4client.addon.utils.font.TTFFontRender;
...
public class JelloScreen extends Screen {
    public static Identifier IDAlt,IDExit,IDLogo,IDMulitPlayer,IDSettings,IDSinglePlayer,IDBg,IDBg1;static {IDAlt = new Identifier("ov4-client", "jello/altmanager.png");IDExit = new Identifier("ov4-client", "jello/exit.png");IDLogo = new Identifier("ov4-client", "jello/jellologo.png");IDMulitPlayer = new Identifier("ov4-client", "jello/multiplayer.png");IDSettings = new Identifier("ov4-client", "jello/settings.png");IDSinglePlayer = new Identifier("ov4-client", "jello/singleplayer.png");IDBg = new Identifier("ov4-client", "jello/bg.png");IDBg1 = new Identifier("ov4-client", "jello/bg1.png");}
