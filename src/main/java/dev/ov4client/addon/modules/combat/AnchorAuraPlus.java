...
import dev.ov4client.addon.events.PreRotationEvent;
...
public class AnchorAuraPlus extends ov4Module {
    public AnchorAuraPlus() {
        super(ov4client.Combat, "Anchor Aura Plus", "Automatically destroys people using anchors.");
    }
