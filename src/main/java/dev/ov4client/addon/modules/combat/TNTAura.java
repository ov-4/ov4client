...
import static dev.ov4client.addon.utils.entity.EntityInfo.isSurrounded;
...
public class TNTAura extends ov4Module {
    ...
    public TNTAura() {
        super(ov4client.Combat, "TNT Aura", "Placing & igniting TNT around enemy");
    }
