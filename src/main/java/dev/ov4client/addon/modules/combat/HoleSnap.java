...
import dev.ov4client.addon.utils.world.hole.Hole;
...
public class HoleSnap extends ov4Module {
    public HoleSnap() {
        super(ov4client.Combat, "Hole Snap", "Move to the hole nearby.");
    }
        ...
        if (mc.player != null && mc.world != null) {
            ...
            if (hole != null && !singleBlocked()) {
                ...
                if (mc.player.getX() == hole.middle.x && mc.player.getZ() == hole.middle.z) {
                    ...
                    } else if (ov4Utils.inside(mc.player, mc.player.getBoundingBox().offset(0, -0.05, 0))) {
                        this.toggle();
                    ...
                    if (ov4Utils.inside(mc.player, mc.player.getBoundingBox().offset(x, 0, z))) {
                        collisions++;
                    ...
                    if (ticks > 0) {
                        ticks--;
                    } else if (ov4Utils.inside(mc.player, mc.player.getBoundingBox().offset(0, -0.05, 0)) && jump.get()) {
