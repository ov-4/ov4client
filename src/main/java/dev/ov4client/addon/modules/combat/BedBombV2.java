...
import dev.ov4client.addon.utils.player.BedUtils;
...
import static dev.ov4client.addon.utils.player.BedUtils.*;
import static dev.ov4client.addon.utils.world.BlockInfo.*;

public class BedBombV2 extends ov4Module {
    public BedBombV2() {
        super(ov4client.Combat, "Bed Bomb V2", "Automatically places and explodes beds in the Nether and End :massivetroll:.");
    }
