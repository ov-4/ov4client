...
import dev.ov4client.addon.utils.player.CrystalUtils;
import dev.ov4client.addon.utils.player.Interaction;
import dev.ov4client.addon.utils.render.RenderInfo;
...
import static dev.ov4client.addon.utils.entity.EntityInfo.*;
import static dev.ov4client.addon.utils.world.PredictionUtils.returnPredictBox;
import static dev.ov4client.addon.utils.render.RenderUtils.*;

public class AutoCrystal extends ov4Module {
    public AutoCrystal() {
        super(ov4client.Combat, "Auto Crystal", "Automatically place and attack crystals in less strict anti-cheat servers.");
    }
