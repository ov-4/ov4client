...
import static dev.ov4client.addon.hud.ToastNotifications.addToast;
import static dev.ov4client.addon.utils.entity.EntityInfo.getBlockPos;
import static dev.ov4client.addon.utils.world.BlockInfo.isCombatBlock;

public class Notifications extends ov4Module {
    ...
    public Notifications() {
        super(ov4client.Info, "Notifications", "Sends messages in hud about different events.");
    }
