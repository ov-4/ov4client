...
import dev.ov4client.addon.mixins.IRaycastContext;
...
public class RaytraceSettings extends ov4Module {
    public RaytraceSettings() {
        super(ov4client.Settings, "Raytrace", "Global raytrace settings for every ov4 module.");
    }
