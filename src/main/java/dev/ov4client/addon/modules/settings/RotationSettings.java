...
import dev.ov4client.addon.managers.impl.RotationManager;
...
public class RotationSettings extends ov4Module {
    public RotationSettings() {
        super(ov4client.Settings, "Rotate", "Global rotation settings for every ov4 module.");
    }
