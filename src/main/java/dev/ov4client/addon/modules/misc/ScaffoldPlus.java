...
public class ScaffoldPlus extends ov4Module {
    public ScaffoldPlus() {
        super(ov4client.Misc, "Scaffold Plus", "Places blocks under your feet to help you to move.");
    }
    ...
    private List<BlockPos> getBlocks() {
        ...
        for (int i = 0; i < extrapolation.get() * 10; i++) {
            ...
            if (smart.get() && inside(getBox(vec))) {
                ...
                if (!timers.contains(pos) && ov4Utils.replaceable(pos) && !list.contains(pos) &&
