...
public class StrictNoSlow extends ov4Module {
    public StrictNoSlow() {
        super(ov4client.Misc, "Strict No Slow", "Should only be used on very strict servers. Requires any other noslow to work.");
    }
