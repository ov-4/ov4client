...
import static dev.ov4client.addon.utils.timers.TimerUtils.getTPSMatch;

public class XPThrower extends ov4Module {
    public XPThrower() {
        super(ov4client.Combat, "XP Thrower", "Throw XP bottles to repair your armor and tools.");
    }
