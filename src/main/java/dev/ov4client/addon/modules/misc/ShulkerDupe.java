...
public class ShulkerDupe extends ov4Module {

    private final SettingGroup sgAutoTool = settings.createGroup("AutoTool");

    public ShulkerDupe() {
        super(ov4client.Misc, "Shulker Dupe", "ShulkerDupe only works in vanilla, forge, and fabric servers version 1.19 and below.");
    }
