...
import dev.ov4client.addon.utils.player.CraftUtils;
...
import static dev.ov4client.addon.utils.entity.EntityInfo.isInHole;
import static dev.ov4client.addon.utils.entity.EntityInfo.isMoving;
import static dev.ov4client.addon.utils.misc.Vec3dInfo.closestVec3d;
import static dev.ov4client.addon.utils.player.CraftUtils.getEmptySlots;
import static dev.ov4client.addon.utils.player.CraftUtils.isInventoryFull;
import static dev.ov4client.addon.utils.world.BlockInfo.getBlock;
import static dev.ov4client.addon.utils.world.BlockInfo.getSphere;

public class BedCrafter extends ov4Module {
    public BedCrafter() {
        super(ov4client.Misc, "Bed Crafter", "Automatically craft beds.");
    }
